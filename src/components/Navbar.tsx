...
export default function Navbar() {
  ...
  const progress = { completed: completedTutorials.length, total: tutorials.length };
      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <form onSubmit={handleSearch} className="hidden md:block flex-1 max-w-md mx-8">
          <div className="relative">
            ...
            />
            <kbd className="absolute right-3 top-1/2 -translate-y-1/2 hidden lg:inline-flex items-center gap-1 rounded border border-white/10 bg-white/5 px-1.5 py-0.5 text-[10px] text-gray-400">
              ⌘K
            </kbd>
          </div>
        </form>
